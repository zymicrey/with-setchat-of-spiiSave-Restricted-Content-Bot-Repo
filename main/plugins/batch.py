    ...
    async with gagan.conversation(event.chat_id) as conv: 
        if not s:
            ...
            cd = await conv.send_message("**Batch process ongoing...**\n\nProcess completed: ", 
                                    buttons=[[Button.url("Join Channel", url="http://t.me/team_remo8898")]])
            ...
            if int(fw.value) > 300:
                ...
                try:
                    ...
                    if countdown.text != count_down:
                        await countdown.edit(count_down, buttons=[[Button.url("Join Channel", url="http://t.me/team_remo8898")]])
        except Exception as e:
            #print(e)
            logger.info(e)
...
TEXT = "Namaste🙏, This is 'Paid Restricted Content Saver' bot Made with ❤️ Team REMO."
